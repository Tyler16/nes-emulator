...
fn read_screen_state(cpu: &mut CPU, frame: &mut [u8; 32 * 3 * 32]) -> bool {
    ...
    for i in 0x0200..0x600 {
        let color_idx: u8 = cpu.mem_read(i as u16);
...
fn main() {
    ...
    let creator: sdl2::render::TextureCreator<sdl2::video::WindowContext> = canvas.texture_creator();
    let mut texture: sdl2::render::Texture = creator
